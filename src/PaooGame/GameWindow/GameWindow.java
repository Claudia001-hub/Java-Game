...
/* \class GameWindow
    ...
    ferestre grafice si totdeauna si ce a unui container (toate elementele
    grafice vor fi continute de fereastr).
 */
public class GameWindow {
    ...
    public void BuildGameWindow() {
        ...
        /// Seteaza culoarea fundalului in gri
        wndFrame.getContentPane().setBackground(Color.lightGray);
        ...
        /// Operatia de redimenionare a ferestrei este anulata. Jucatorul
        /// este restrans sa se joace in fereastra de dimensiunile stabilite
        wndFrame.setResizable(false);
        /// Fereastra apare in mijlocul ecranului
        /// Pentru alte pozitii se va apela "wndFrame.setLocation(x, y)"
